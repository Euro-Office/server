...
const baseConnector = require('coauthoring/sources/databaseConnectors/baseConnector');
const wopiUtils = require('coauthoring/sources/wopiUtils');
const taskResult = require('coauthoring/sources/taskresult');
